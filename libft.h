...
/*   Updated: 2022/11/02 18:30:28 by jarregui         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			*ft_memchr(const void *s, int c, unsigned int n); /* MISSING */
int				ft_memcmp(const void *s1, const void *s2, unsigned int n); /* MISSING */
void			*ft_memcpy(void *dst, const void *src, unsigned int n); /* OK */
void			*ft_memmove(void *dst, const void *src, unsigned int len); /* MISSING */
...
char			*ft_strchr(const char *s, int c); /* MISSING */
char			*ft_strdup(const char *s1); /* MISSING */
...
char			*ft_strnstr(const char *haystack, const char *needle, unsigned int len); /* MISSING */
char			*ft_strrchr(const char *s, int c); /* MISSING */
